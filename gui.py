...
class FrameUTab:
    ...
    def load_button_u(self):
        ...
        self.mU = u['m']
        self.vU = u['v']
        self.messageButton = tk.Button(self.frame,text = "A",state='disabled',background='lightblue')
        ToolTip(self.messageButton,msg=str(self.AU))
        self.messageButton.place(x = 526,y = 132,width=173, height=173)
        self.messageButton['font'] = self.myFont
        self.error1Button = tk.Button(self.frame,text = "A",state='disabled',background='lightblue')
        ToolTip(self.error1Button,msg=str(self.AU))
        self.error1Button.place(x = 526,y = 345,width=173, height=173)
        self.error1Button['font'] = self.myFont
        self.error2Button = tk.Button(self.frame,text = "r",state='disabled',background='lightgreen')
        ToolTip(self.error2Button,msg=str(self.rU))
        self.error2Button.place(x = 340,y = 132,width=173, height=48)
        self.error2Button['font'] = self.myFont
        self.uButton = tk.Button(self.frame,text = "r",state='disabled',background='lightgreen')
        ToolTip(self.uButton,msg=str(self.rU))
        self.uButton.place(x = 340,y = 345,width=173, height=48)
        self.uButton['font'] = self.myFont
        self.error2Button = tk.Button(self.frame,text = "r",state='disabled',background='lightgreen')
        ToolTip(self.error2Button,msg=str(self.rU))
        self.error2Button.place(x = 340,y = 132,width=173, height=48)
        ...
        self.uButton.place(x = 340,y = 345,width=173, height=48)
        self.uButton['font'] = self.myFont
        self.vButton = tk.Button(self.frame,text = "u",state='disabled',background='red')
        ToolTip(self.vButton,msg=str(self.u))
        self.vButton.place(x = 40,y = 132,width=173, height=48)
        self.vButton['font'] = self.myFont
        self.vButton = tk.Button(self.frame,text = "e1",state='disabled',background='yellow')
        ToolTip(self.vButton,msg=str(self.e1U))
        self.vButton.place(x = 740,y = 132,width=173, height=48)
        self.vButton['font'] = self.myFont
        self.vButton = tk.Button(self.frame,text = "v",state='disabled',background='red')
        ToolTip(self.vButton,msg=str(self.vU))
        self.vButton.place(x = 897,y = 407,width=48, height=48)
        self.vButton['font'] = self.myFont
        self.vButton = tk.Button(self.frame,text = "m",state='disabled',background='lightgrey')
        ToolTip(self.vButton,msg=str(self.mU))
        self.vButton.place(x = 974,y = 407,width=48, height=48)
        self.vButton['font'] = self.myFont
    ...
    def load_button_skU(self):
        with open("keyGenSecretData.pickle", "rb") as s_in:
            ...
            s = pickle.load(s_in)
        self.s = s['s']
        self.vButton = tk.Button(self.frame,text = "s",state='disabled',background='lightgreen')
        ToolTip(self.vButton,msg=str(self.s))
        self.vButton.place(x = 708,y = 345,width=48, height=173)
        self.vButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "s",state='disabled',background='lightgreen')
        ToolTip(self.messageButton,msg=str(self.s))
        self.messageButton.place(x = 937,y = 132,width=48, height=173)
        self.messageButton['font'] = self.myFont
        self.error1Button = tk.Button(self.frame,text = "s",state='disabled',background='lightgreen')
        ToolTip(self.error1Button,msg=str(self.s))
        self.error1Button.place(x = 222,y = 132,width=48, height=173)
        self.error1Button['font'] = self.myFont
...
class FrameVTab:
    def __init__(self, notebook):
        ...
        self.loadButtont = ttk.Button(self.frame,text = "Load A/e",command=self.load_t_detailed_v)
        self.loadButtont.place(x = 100, y = 630)
        self.loadButtonsk = ttk.Button(self.frame,text = "Load s",command=self.load_button_skV)
        self.loadButtonsk.place(x = 190, y = 630)
        self.messageButton = tk.Button(self.frame,text = "E",state='disabled',background='yellow')
        ToolTip(self.messageButton,msg="e + e2")
        self.messageButton.place(x = 710,y = 523,width=48, height=48)
        self.messageButton['font'] = self.myFont
    ...
    def load_button_v(self):
        ...
        self.mV = v['m']
        self.rV = v['r']
        self.vButton = tk.Button(self.frame,text = "r",state='disabled',background='lightgreen')
        ToolTip(self.vButton,msg=str(self.rV))
        self.vButton.place(x = 248,y = 31,width=175, height=48)
        self.vButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "r",state='disabled',background='lightgreen')
        ToolTip(self.messageButton,msg=str(self.rV))
        self.messageButton.place(x = 248,y = 246,width=175, height=48)
        self.messageButton['font'] = self.myFont
        self.vButton = tk.Button(self.frame,text = "r",state='disabled',background='lightgreen')
        ToolTip(self.vButton,msg=str(self.rV))
        self.vButton.place(x = 248,y = 460,width=175, height=48)
        self.vButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "t",state='disabled',background='lightblue')
        ToolTip(self.messageButton,msg=str(self.tV))
        self.messageButton.place(x = 430,y = 31,width=48, height=175)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "e2",state='disabled',background='yellow')
        ToolTip(self.messageButton,msg=str(self.e2V))
        self.messageButton.place(x = 522,y = 94,width=48, height=48)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "e2",state='disabled',background='yellow')
        ToolTip(self.messageButton,msg=str(self.e2V))
        self.messageButton.place(x = 817,y = 309,width=48, height=48)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "m",state='disabled',background='lightgrey')
        ToolTip(self.messageButton,msg=str(self.mV))
        self.messageButton.place(x = 611,y = 94,width=48, height=48)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "m",state='disabled',background='lightgrey')
        ToolTip(self.messageButton,msg=str(self.mV))
        self.messageButton.place(x = 908,y = 309,width=48, height=48)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "m",state='disabled',background='lightgrey')
        ToolTip(self.messageButton,msg=str(self.mV))
        self.messageButton.place(x = 817,y = 523,width=48, height=48)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "v",state='disabled',background='red')
        ToolTip(self.messageButton,msg=str(self.v))
        self.messageButton.place(x = 145,y = 94,width=48, height=48)
        self.messageButton['font'] = self.myFont
    ...
    def load_t_detailed_v(self):
        ...
        self.eV = t['e']
        self.messageButton = tk.Button(self.frame,text = "A",state='disabled',background='lightblue')
        ToolTip(self.messageButton,msg=str(self.A))
        self.messageButton.place(x = 440,y = 246,width=175, height=175)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "A",state='disabled',background='lightblue')
        ToolTip(self.messageButton,msg=str(self.A))
        self.messageButton.place(x = 440,y = 460,width=175, height=175)
        self.messageButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "e",state='disabled',background='yellow')
        ToolTip(self.messageButton,msg=str(self.eV))
        self.messageButton.place(x = 710,y = 246,width=48, height=175)
        self.messageButton['font'] = self.myFont
    ...
    def load_button_skV(self):
        ...
        self.vButton = tk.Button(self.frame,text = "s",state='disabled',background='lightgreen')
        ToolTip(self.vButton,msg=str(self.s))
        self.vButton.place(x = 625,y = 460,width=48, height=175)
        self.vButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "s",state='disabled',background='lightgreen')
        ToolTip(self.messageButton,msg=str(self.s))
        self.messageButton.place(x = 625,y = 245,width=48, height=175)
        self.messageButton['font'] = self.myFont
...
class DecryptionTab:
    ...
    def button_LoadCipherText(self):
        ...
        self.vButton = tk.Button(self.frame,text = "u",state='disabled',background='red')
        ToolTip(self.vButton,msg=str(self.u))
        self.vButton.place(x = 148,y = 465,width=175, height=48)
        self.vButton['font'] = self.myFont
        self.messageButton = tk.Button(self.frame,text = "v",state='disabled',background='red')
        ToolTip(self.messageButton,msg=str(self.v))
        self.messageButton.place(x = 64,y = 526,width=48, height=48)
        self.messageButton['font'] = self.myFont
    ...
    def button_decryptSteps(self):
        ...
        self.m_nLabel = ttk.Label(self.frame,text = "Coefficients of the message: " + str(res['m_nSplit']))
        self.m_nLabel.place(x = 100, y =230)
        self.m_nLabel = ttk.Label(self.frame,text = "Coefficients after decoding: " + str(res['coefficients']))
        self.m_nLabel.place(x = 100, y =260)
        self.m_nLabel = ttk.Label(self.frame,text = "Result after compression: " + str(res['m_nSplitDsc']))
        self.m_nLabel.place(x = 100, y =290)
        self.m_nLabel = ttk.Label(self.frame,text = "Bit representation to char: " + str(res['result']['msg']))
        self.m_nLabel.place(x = 100, y =320)
