...
class FrameVTab:
    ...
    def load_button_v(self):
        ...
        ToolTip(self.rButtonHover,msg=str(smallRandomXbarToX(self.rV)))
        ...
        ToolTip(self.rButtonHover2,msg=str(smallRandomXbarToX(self.rV)))
        ...
        ToolTip(self.rButtonHover3,msg=str(smallRandomXbarToX(self.rV)))
        ...
        ToolTip(self.tButtonHover,msg=str(smallRandomXbarToX(self.tV)))
        ...
        ToolTip(self.e2ButtonHover,msg=str(msgXbarToX(self.e2V)))
        ...
        ToolTip(self.e2ButtonHover2,msg=str(msgXbarToX(self.e2V)))
        ...
        ToolTip(self.mButtonHover,msg=str(msgXbarToX(self.mV)))
        ...
        ToolTip(self.mButtonHover2,msg=str(msgXbarToX(self.mV)))
        ...
        ToolTip(self.mButtonHover3,msg=str(msgXbarToX(self.mV)))
    ...
    def load_t_detailed_v(self):
        ...
        ToolTip(self.AButtonHover,msg=str(matrixXbartoX(self.A)))
        ...
        ToolTip(self.AButtonHover2,msg=str(matrixXbartoX(self.A)))
        ...
        ToolTip(self.eButtonHover,msg=str(smallRandomXbarToX(self.eV)))
